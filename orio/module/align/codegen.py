...
class CodeGen:
    ...
    def __init__(self, vars, annot_body_code, indent, language="c"):
        ...
        if language in ["c", "c++", "cxx"]:
            ...
            err(
                "orio.module.align.codegen: Unknown language specified for code generation: %s"
                % language
            )
...
class CodeGen_F(CodeGen):
    ...
    def generate(self):
        ...
        raise NotImplementedError(
            "%s: Fortran code generation not implemented yet for align module"
        )
        # return the generated code
        return s
