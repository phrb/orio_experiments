...
def t_error(t):
    err(
        'orio.module.ortil.code_parser: OrTil:%s: syntactical error: "%s"'
...
def p_assignment_expression_2(p):
    ...
    if p[2] == "=":
        ...
        if p[2] == "*=":
            ...
            err(
                "orio.module.ortil.code_parser internal error:OrTil: unknown assignment operator"
            )
...
def p_equality_expression_2(p):
    ...
    if p[2] == "==":
        ...
        err(
            "orio.module.ortil.code_parser internal error:OrTil: unknown equality operator"
        )
...
def p_relational_expression_2(p):
    ...
    if p[2] == "<":
        ...
        err(
            "orio.module.ortil.code_parser internal error:OrTil: unknown relational operator"
        )
...
def p_additive_expression_2(p):
    ...
    if p[2] == "+":
        ...
        err(
            "orio.module.ortil.code_parser internal error:OrTil: unknown additive operator"
        )
...
def p_multiplicative_expression_2(p):
    ...
    if p[2] == "*":
        ...
        err(
            "orio.module.ortil.code_parser internal error:OrTil: unknown multiplicative operator"
        )
...
def p_unary_expression_4(p):
    ...
    if p[1] == "+":
        ...
        err(
            "orio.module.ortil.code_parser internal error:OrTil: unknown unary operator"
        )
...
def p_error(p):
    err(
        'orio.module.ortil.code_parser: OrTil:%s: grammatical error: "%s"'
