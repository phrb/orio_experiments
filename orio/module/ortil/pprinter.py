    ...
    def pprint(self, tnode, indent="  ", extra_indent="  "):
        ...
        if isinstance(tnode, ast.NumLitExp):
            ...
            if tnode.op_type == tnode.PLUS:
                ...
                err(
                    "orio.module.ortil.pprinter internal error:OrTil: unknown unary operator type: %s"
                    % tnode.op_type
                )
            ...
            if tnode.op_type == tnode.MUL:
                ...
                err(
                    "orio.module.ortil.pprinter internal error:OrTil: unknown binary operator type: %s"
                    % tnode.op_type
                )
            ...
            err(
                "orio.module.ortil.pprinter internal error:OrTil: unrecognized type of AST: %s"
