    ...
    def generate(self, tnode, indent="  ", extra_indent="  "):
        ...
        if isinstance(tnode, ast.NumLitExp):
            ...
            if tnode.op_type == tnode.PLUS:
                ...
                g.err(
                    "orio.module.loop.codegen_opencl internal error: unknown unary operator type: %s"
                    % tnode.op_type
                )
            ...
            if tnode.op_type == tnode.MUL:
                ...
                g.err(
                    "orio.module.loop.codegen_opencl internal error: unknown binary operator type: %s"
                    % tnode.op_type
                )
            ...
            g.err(
                "orio.module.loop.codegen_opencl internal error: a transformation statement is never generated as an output"
            )
            ...
            g.err(
                "orio.module.loop.codegen_opencl internal error: unrecognized type of AST: %s"
