...
class CParser(PLYParser):
    ...
    def __init__(
        ...
        """
        self.clex = CLexer(
            error_func=self._lex_error_func, type_lookup_func=self._lex_type_lookup_func
        )
    ...
    def p_function_definition_1(self, p):
        ...
        p[0] = self._build_function_definition(
            decl=p[1], spec=spec, param_decls=p[2], body=p[3]
        )
    ...
    def p_function_definition_2(self, p):
        ...
        p[0] = self._build_function_definition(
            decl=p[2], spec=spec, param_decls=p[3], body=p[4]
        )
    ...
    def p_direct_declarator_1(self, p):
        ...
        """
        p[0] = c_ast.TypeDecl(
            declname=p[1], type=None, quals=None, coord=self._coord(p.lineno(1))
        )
    ...
    def p_direct_declarator_4(self, p):
        ...
        """
        arr = c_ast.ArrayDecl(
            type=None, dim=c_ast.ID(p[3], self._coord(p.lineno(3))), coord=p[1].coord
        )
    ...
    def p_pointer(self, p):
        ...
        p[0] = c_ast.PtrDecl(
            quals=p[2] or [], type=p[3] if len(p) > 3 else None, coord=coord
        )
    ...
    def p_iteration_statement_4(self, p):
        ...
        p[0] = c_ast.For(
            c_ast.DeclList(p[3]), p[4], p[6], p[8], self._coord(p.lineno(1))
        )
    ...
    def p_unary_expression_3(self, p):
        ...
        """
        p[0] = c_ast.UnaryOp(
            p[1], p[2] if len(p) == 3 else p[3], self._coord(p.lineno(1))
        )
